...
Begin VB.Form Form_ReportFC1 
   Caption         =   "Forecast Actual"
   ClientHeight    =   5520
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   10650
   ...
   Begin VB.ComboBox cmbFiletype 
      Height          =   390
      ItemData        =   "Form_ReportFC1.frx":0000
      Left            =   8880
      List            =   "Form_ReportFC1.frx":000A
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   960
      OleObjectBlob   =   "Form_ReportFC1.frx":0023
      Top             =   360
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   375
      Left            =   120
      OleObjectBlob   =   "Form_ReportFC1.frx":0257
      TabIndex        =   2
      Top             =   120
      Width           =   615
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
      Height          =   375
      Left            =   3000
      OleObjectBlob   =   "Form_ReportFC1.frx":02BB
      TabIndex        =   10
      Top             =   120
      Width           =   255
   End
   ...
   End
End
Attribute VB_Name = "Form_ReportFC1"
...
Private Sub cmdView_Click()
    ...
    qry = "select item_id,item_name from mst_item a " _
    & "  where pfm_id='10' and item_id not like 'TEST' order by item_id asc"
    ...
    If RsBantu.RecordCount > 0 Then
        ...
        With grid1
            ...
            While Not RsBantu.EOF
                .TextMatrix(r, 0) = Trim$(RsBantu("item_id"))
                .TextMatrix(r, 1) = RsBantu("item_name")
                r = r + 1
                RsBantu.MoveNext
            Wend
            .Cols = 2 + bedaBulan
    ...
    & " group by a.item_id,period,period_h order by period_h asc"
    ...
    If totalR > 0 Then
        ...
        With grid1
            While Not RsBantu.EOF
                For it = 2 To .rows - 1
                    For ik = 2 To .Cols - 1
                        If RsBantu("item_id") = .TextMatrix(it, 0) And RsBantu("period") = .TextMatrix(0, ik) & NameToID(.TextMatrix(1, ik)) _
