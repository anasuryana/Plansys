Attribute VB_Name = "CellPrint"
'www.arief.in
Public Sub PrintCell(ByVal objectPrint As Object, ByVal xPos As Long, ByVal yPos As Long, ByVal cellWidth As Double, ByVal cellHeight As Double, Optional str As String, Optional cellFontSize As Long, Optional line As Boolean, Optional lineColor As Long, Optional hAlign As Integer, Optional vAlign As Integer, Optional paddingLeft As Integer, Optional paddingTop As Integer, Optional paddingRight As Integer, Optional paddingBottom As Integer)
    ...
    End If
    If line = True Then
        objectPrint.Line (xPos, yPos)-Step(cellWidth, cellHeight), lineColor, B
    End If
    objectPrint.FontSize = cellFontSize
    If hAlign = 1 Then 'horizontal align : right
        objectPrint.CurrentX = xPos + cellWidth - objectPrint.TextWidth(str) - paddingRight
