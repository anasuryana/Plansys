Attribute VB_Name = "MSFlexGridMouseWheel"
Option Explicit
...
'      Lstep = Lstep - rowFixHeader
'    Loop
'    If Rotation > 0 Then
'        NewValue = .TopRow - Lstep
'        If NewValue < rowFixHeader Then
'            NewValue = rowFixHeader
'        End If
'    Else
'        NewValue = .TopRow + Lstep
'        If NewValue > .rows - rowFixHeader Then
'            NewValue = .rows - rowFixHeader
'        End If
'    End If
'    .TopRow = NewValue
'  End With
